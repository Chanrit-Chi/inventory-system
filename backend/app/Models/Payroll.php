...
class Payroll extends Model
{
    ...
    protected $casts = [
        ...
        'incentive_override' => 'decimal:2',
        'thirteenth_month_contribution' => 'decimal:2',
        'thirteenth_month_payout' => 'decimal:2',
        'performance_benefit' => 'decimal:2',
        'delivery_benefit' => 'decimal:2',
        'overtime_days' => 'float',
        'overtime_amount' => 'decimal:2',
        'unpaid_leave_days' => 'float',
        'unpaid_leave_deduction' => 'decimal:2',
        'collective_benefit' => 'decimal:2',
