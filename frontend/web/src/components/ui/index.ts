/**
 * OmniPOS UI Component Primitives Library
 * Built with Radix Vue + Tailwind CSS v4 design tokens.
 *
 * Usage:
 *   import { Button, Card, Badge, Input, Table, Dialog, Select, Tabs, Switch, Skeleton, Toast, Alert, StatCard, EmptyState } from '@/components/ui'
 */
